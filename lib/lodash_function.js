...
exports.modArgs = function (func) {
  var transforms = tools.slice(arguments, 1);
...
exports.partialRight = function (func) {
  var args = tools.slice(arguments, 1);
  ...
  return function () {
    ...
    return func.apply(null, innerArgs.concat(args))
  }
}